...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("smilecoin://"))
    {
        uri.replace(0, 11, "smilecoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "smilecoin.lnk";
}
...
{
    return GetAutostartDir() / "smilecoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("smilecoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("smilecoin-Qt"));
