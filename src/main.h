...
static const int64 MAX_MONEY = 10000000000 * COIN; // smileCoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // smileCoin: 1440 blocks found a day. Priority cutoff is 100 smilecoin day / 250 bytes.
    }
