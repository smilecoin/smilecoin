Mac OS X smilecoind build instructions
====================================
...
See `doc/readme-qt.rst` for instructions on building smilecoin-Qt, the
...
Much of this may be outdated for smilecoin.
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:smilecoin-project/smilecoin.git smilecoin
        cd smilecoin
...
For boost in smilecoin, there are some ‘fun’ things you have to do:
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:smilecoin/smilecoin.git smilecoin
        cd smilecoin
...
commands:
    ...
    echo -e "rpcuser=smilecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/smilecoin/smilecoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/smilecoin/smilecoin.conf"
...
Other commands:
    ...
    ./smilecoind --help  # for a list of command-line options.
    ./smilecoind -daemon # to start the smilecoin daemon.
    ./smilecoind help    # When the daemon is running, to get a list of RPC commands
